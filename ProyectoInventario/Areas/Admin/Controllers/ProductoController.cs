...
namespace ProyectoInventario.Areas.Admin.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        //IWebHostEnvironment es para acceder al directorio root
        ...
        public async Task<IActionResult> Upsert(ProductoVM productoVM)
        {
            ...
            //if not valid
            productoVM.CategoriaLista = _unidadTrabajo.Producto.ObtenerTodosDropDownLista("Lista");
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            //remover la imagen del directorio root
